<footer class="footer">
        <div class="content">
                ...
                <div class="contact-info">
                    ...
                    <ul>
                        <i class="fas fa-map-marker-alt"></i> END. Store <br>
                        <i class="fas fa-phone"></i> (111) 111 111 111<br>
                        <i class="fas fa-envelope-open-text"></i> contacto@end.mx
                    </ul>
        ...
        <p>© Copyright [0] ENDmx. Todos los derechos reservados.</p>
