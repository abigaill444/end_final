...
<main class= "contenedor seccion">
        ...
        <div class="form">
            <form class= "formulario" method="post" action="actualizarArticulo.php?id=<?php echo $mensaje ?>" name="articulo" id="articulo">
                <fieldset>
                    <legend> <h1>Actualizar artículo</h1> </legend><br>

                    <select name="producto" style="width: 270px">
                    ...
                    <?php
                        ...
                        while($row = $query->fetch_assoc()) {
                            echo '<option name="'.$row["id_Articulo"].'" value="'.$row["id_Articulo"].'">'.$row["id_Articulo"]." - ".$row["nombre"].'</option>';
                            $id = $row["id_Articulo"];
                        }
                    ?>
                    </select><br><br>
                    ...
                    <div class="message" style="width: 270px; margin: 0 auto">
                        <input type="submit" value="Enviar" style="margin-bottom: 2rem"><br><br>
                    </div>
                </fieldset>
            </form>
        </div>
