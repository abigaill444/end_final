...
<main class="contenedor seccion">
    <a style="display: flex; align-items: center; justify-content: center;"><?php echo $mensaje ?></a>
        <div class="form" style="display: block">
            ...
            <fieldset>
            <legend> <h1>Borrar artículo</h1> </legend><br>
    ...
    <div class="form <?php echo $style; ?>">
        <form class= "formulario" method="POST" action="borrarAction.php" enctype="multipart/form-data" >
            <fieldset>
                ...
                <input readonly type = "text" id = "nombre" name ="nombre" value = "<?php echo $nombre; ?>"><br><br>

                <label for="precio"><b>  Precio: </b></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input readonly type = "number" id = "precio" name="precio" value = "<?php echo $precio; ?>"><br><br>

                <label for="marca"><b>  Marca: </b></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input readonly type = "text" id = "marca" name="marca" value = "<?php echo $marca; ?>"><br><br>

                <label for="existencia"><b>  Existentes: </b></label>
                <input readonly type = "number" id = "existencia" name="existencia" value = "<?php echo $existencia; ?>"><br><br>

                <label for="descripcion"><b>  Descripción: </b></label><br><br>
                <textarea readonly id="descripcion" name="descripcion" style="width: 270px; height: 100px"><?php echo $descripcion; ?></textarea><br><br>
            ...
            <br>
            <div class="message">
                <input type="submit" value="Borrar" style="margin-bottom: 2rem">
            </div>
        </form>
    </div>
    <br><br>
